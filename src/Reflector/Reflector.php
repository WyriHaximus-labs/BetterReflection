...
class Reflector
{
     ...
     */
    public function reflectClass(string $identifierName): Reflection
    {
     ...
     * @throws IdentifierNotFound
     */
    public function reflectFunction(string $identifierName): Reflection
    {
     ...
     * @throws IdentifierNotFound
     */
    public function reflectConstant(string $identifierName): Reflection
    {
