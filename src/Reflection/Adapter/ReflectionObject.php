...
class ReflectionObject extends CoreReflectionObject
{
    ...
    public function getMethod(string $name): CoreReflectionMethod
    {
    ...
    /**
     * @return list<CoreReflectionMethod>
     *
    ...
    public function getProperty(string $name): CoreReflectionProperty
    {
    ...
    /**
     * @return list<CoreReflectionProperty>
     *
     * @psalm-suppress MethodSignatureMismatch
     */
    ...
    public function getReflectionConstant(string $name): CoreReflectionClassConstant|false
    {
    ...
    /**
     * @return list<CoreReflectionClassConstant>
     */
    ...
    public function newInstance(mixed ...$args): CoreReflectionObject
    {
        throw new Exception\NotImplemented('Not implemented');
    }

    public function newInstanceWithoutConstructor(): CoreReflectionObject
    {
        throw new Exception\NotImplemented('Not implemented');
    }

    public function newInstanceArgs(?array $args = null): CoreReflectionObject
    {
        throw new Exception\NotImplemented('Not implemented');
    }

    public function getParentClass(): CoreReflectionClass|false
    {
