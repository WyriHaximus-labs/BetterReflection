...
class ReflectionMethodStringCastTest extends TestCase
{
    ...
    {
        $reflector       = new Reflector(new SingleFileSourceLocator(__DIR__ . '/../../Fixture/StringCastMethods.php', $this->astLocator));
    ...
    public function testToStringForInternal(): void
    {
        ...
        $classReflection = (new Reflector(new PhpInternalSourceLocator($this->astLocator, $this->sourceStubber)))->reflectClass(Exception::class);
        // phpcs:enable
